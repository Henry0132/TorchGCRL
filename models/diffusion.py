...
from utils.helpers import cosine_beta_schedule, linear_beta_schedule, vp_beta_schedule, extract, Losses, SinusoidalPosEmb
...
class MLP(nn.Module):
    ...
    def __init__(self,
        ...
        input_dim = state_dim + action_dim + goal_dim + t_dim
    ...
    def forward(self, x, time, state, goal):
...
class Diffusion(nn.Module):
    def __init__(self, state_dim, action_dim, goal_dim, model, max_action,
    ...
    def p_mean_variance(self, x, t, s, g):
    ...
    def p_losses(self, x_start, state, goal, t, weights=1.0):
        noise = torch.randn_like(x_start)
    ...
    def loss(self, x, state, goal, weights=1.0):
        batch_size = len(x)
